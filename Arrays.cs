...
namespace ElTrompo
{
    class Arrays
    {
        public string[] turno = { "Vespertino", "Matutino", "Diurno" };

        public string[] sector = { "Publica", "Privada" };

        public string[] estados = {"Aguascalientes", "Baja California", "Baja California Sur", "Campeche", "Coahuila", "Colima",
        ...
        public string[] AguascalientesMun = {"Aguascalientes", "Asientos", "Calvillo", "Cosio", "El llano", "Jesus Maria",
                                "Pabellon de Arteaga", "Rincon de Romos", "San Francisco de los Romos", "San Jose de Gracia",
                                "Tepezala"};

        public string[] BajaCaliforniaMun = { "Ensenada", "Mexicali", "Rosarito", "Tecate", "Tijuana" };

        public string[] BajaCaliforniaSMun = { "Comondu", "La Paz", "Loreto", "Los Cabos", "Mulege" };

        public string[] CampecheMun = {"Acacoyagua","Acala","Acapetahua","Aldama","Altamirano","Amatan","Amatenango de la Frontera",
        ...
        public string[] CoahuilaMun = {"Abasolo","Acuña","Allende","Arteaga","Candela","Castaños","Cuatrocienegas","Escobedo","Francisco I. Madero","Frontera",
        ...
        public string[] ColimaMun = { "Armeria", "Colima", "Comala", "Coquimatlan", "Cuauhtemoc", "Ixtlahuacan", "Manzanillo", "Minatitlan", "Tecoman", "Villa de Alvarez" };

        public string[] ChiapasMun = {"Acacoyagua","Acala","Acapetahua","Aldama","Altamirano","Amatan","Amatenango de la Frontera","Amatenango del Valle",
        ...
        public string[] CiudadDeMexicoMun = {"Alvaro Obregon","Azcapotzalco","Benito Juarez","Coyoacan","Cuajimalpa de Morelos","Cuauhtemoc","Gustavo A. Madero","Iztacalco",
                                      "Iztapalapa","Magdalena Contreras","Miguel Hidalgo","Milpa Alta","Tlahuac","Tlalpan","Venustiano Carranza","Xochimilco"};

        public string[] ChihuahuaMun = {"Ahumada","Aldama","Allende","Aquiles Serdan","Ascension","Bachiniva","Balleza","Batopilas","Bocoyna","Buenaventura","Camargo",
        ...
        public string[] DurangoMun = {"Canatlan","Canelas","Coneto de Comonfort","Cuencame","Durango","El Oro","Gomez Palacio","Gral. Simon Bolivar","Guadalupe Victoria",
        ...
        public string[] GuanajuatoMun = {"Abasolo","Acambaro","Apaseo el Alto","Apaseo el Grande","Atarjea","Celaya","Comonfort","Coroneo","Cortazar","Cueramaro","Doctor Mora",
        ...
        public string[] GuerreroMun = {"Acapulco de Juarez","Acatepec","Ahuacuotzingo","Ajuchitlan del Progreso","Alcozauca de Guerrero","Alpoyeca","Apaxtla de Castrejon",
        ...
        public string[] HidalgoMun = {"Acatlan","Acaxochitlan","Actopan","Agua Blanca de Iturbide","Ajacuba","Alfajayucan","Almoloya","Apan","Atitalaquia","Atlapexco",
        ...
        public string[] JaliscoMun = {"Acatic","Acatlan de Juarez","Ahualulco de Mercado","Amacueca","Amatitan","Ameca","Arandas","Atemajac de Brizuela","Atengo","Atenguillo",
        ...
        public string[] MexicoMun = {"Acambay","Acolman","Aculco","Almoloya de Alquisiras","Almoloya de Juarez","Almoloya del Rio","Amanalco","Amatepec","Amecameca","Apaxco",
        ...
        public string[] MichoacanMun = {"Acuitzio","Aguililla","Alvaro Obregon","Angamacutiro","Angangueo","Apatzingan","Aporo","Aquila","Ario de Rosales","Arteaga Riseñas",
        ...
        public string[] MorelosMun = {"Amacuzac","Atlatlahucan","Axochiapan","Ayala","Coatlan del Rio","Cuautla","Cuernavaca","Emiliano Zapata","Huitzilac","Jantetelco",
        ...
        public string[] NayaritMun = {"Acaponeta","Ahuacatlan","Amatlan de Cañas","Bahia de Banderas","Compostela","El Nayar","Huajicori","Ixtlan del Rio","Jala","La Yesca",
                            "Rosamorada","Ruiz","San Blas","San Pedro Lagunillas","Santa Maria del Oro","Santiago Ixcuintla","Tecuala","Tepic","Tuxpan","Xalisco"};

        public string[] NuevoLeonMun = {"Abasolo","Agualeguas","Allende","Anahuac","Apodaca","Aramberri","Bustamante","Cadereyta Jimenez","Cerralvo","China","Cienega de Flores",
        ...
        public string[] OaxacaMun = {"Abejones","Acatlan de Perez Figueroa","Animas Trujano","Asuncion Cacalotepec","Asuncion Cuyotepeji","Asuncion Ixtaltepec",
        ...
        public string[] PueblaMun = {"Acajete","Acateno","Acatlan","Acatzingo","Acteopan","Ahuacatlan","Ahuatlan","Ahuazotepec","Ahuehuetitla","Ajalpan","Albino Zertuche",
        ...
        public string[] QueretaroMun = {"Amealco de Bonfil","Arroyo Seco","Cadereyta de Montes","Colon","Corregidora","El Marques","Ezequiel Montes","Huimilpan",
        ...
        public string[] QuintanaRooMun = {"Benito Juarez","Cozumel","Felipe Carrillo Puerto","Isla Mujeres","Jose Maria Morelos","Lazaro Cardenas","Othon P. Blanco",
                                    "Solidaridad","Tulum"};

        public string[] SanLuisPotosiMun = {"Ahualulco","Alaquines","Aquismon","Armadillo de los Infante","Axtla de Terrazas","Cardenas","Catorce","Cedral","Cerritos",
        ...
        public string[] SinaloaMun = {"Ahome","Angostura","Badiraguato","Choix","Concordia","Cosala","Culiacan","El Fuerte","Elota","El Rosario","Escuinapa","Guasave",
                                "Mazatlan","Mocorito","Navolato","Salvador Alvarado","San Ignacio","Sinaloa de Leyva"};

        public string[] SonoraMun = {"Aconchi","Agua Prieta","Alamos","Altar","Arivechi","Arizpe","Atil","Bacadehuachi","Bacanora","Bacerac","Bacoachi","Bacum","Banamichi",
        ...
        public string[] TabascoMun = {"Balancan","Cardenas","Centla","Centro","Comalcalco","Cunduacan","Emiliano Zapata","Huimanguillo","Jalapa","Jalpa de Mendez","Jonuta",
                            "Macuspana","Nacajuca","Paraiso","Tacotalpa","Teapa","Tenosique"};

        public string[] TamaulipasMun = {"Abasolo","Aldama","Altamira","Antiguo Morelos","Burgos","Bustamante","Camargo","Casas","Ciudad Madero","Cruillas","Gomez Farias",
        ...
        public string[] TlaxcalaMun = {"Acuamanala de Miguel Hidalgo","Altzayanca","Amaxac de Guerrero","Apetatitlan de Antonio Carvajal","Atlangatepec","Apizaco",
        ...
        public string[] VeracruzMun = {"Acajete","Acatlan","Acayucan","Actopan","Acula","Acultzingo","Agua Dulce","alamo Temapache","Alpatlahuac",
        ...
        public string[] YucatanMun = {"Abala","Acanceh","Akil","Baca","Bokoba","Buctzotz","Cacalchen","Calotmul","Cansahcab","Cantamayec","Calestun","Cenotillo","Conkal",
        ...
        public string[] ZacatecasMun = {"Apozol","Apulco","Atolinga","Benito Juarez","Calera","Cañitas de Felipe Pescador","Concepcion del Oro","Cuauhtemoc","Chalchihuites",
